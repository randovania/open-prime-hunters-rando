...
def patch_string_tables(file_manager: FileManager, configuration: dict) -> None:
    ...
    for language in Language:
        ...
        _add_missile_launcher(file_manager, language, ammo_sizes["missile_launcher"])
...
def _add_missile_launcher(file_manager: FileManager, language: Language, missile_launcher_ammo: int) -> None:
    game_messages = file_manager.get_string_table(language, StringTables.GAME_MESSAGES)
