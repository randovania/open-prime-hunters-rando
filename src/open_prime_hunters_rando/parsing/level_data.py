...
class LevelData:
    ...
    portal_file_name: str | None = None
...
ALINOS: dict[str, LevelData] = {
    "Alinos Gateway": LevelData(
        ...
        portal_file_name="unit1_Land_Ent",
    ),
    "Echo Hall": LevelData(
        room_id=28,
        area_name="Alinos",
    ...
    "Stronghold Void A": LevelData(
        ...
        portal_file_name="Unit1_TP1_Ent",
    ),
    ...
    "Council Chamber": LevelData(
        ...
        portal_file_name="unit1_RM3_Ent",
    ),
    "Processor Core": LevelData(
        room_id=41,
        area_name="Alinos",
        entity_file="unit1_rm5_Ent",
        portal_file_name="unit1_RM5_Ent",
    ),
    ...
    "Stronghold Void B": LevelData(
        ...
        portal_file_name="Unit1_TP2_Ent",
    ),
...
CELESTIAL_ARCHIVES: dict[str, LevelData] = {
    "Celestial Gateway": LevelData(
        ...
        portal_file_name="unit2_Land_Ent",
    ),
    "Helm Room": LevelData(
        room_id=46,
        area_name="Celestial Archives",
    ...
    "Synergy Core": LevelData(
        ...
        portal_file_name="unit2_C4_Ent",
    ),
    "Stronghold Void A": LevelData(
        room_id=54,
        area_name="Celestial Archives",
        entity_file="Unit2_TP1_Ent",
        portal_file_name="Unit2_TP1_Ent",
    ),
    "Biodefense Chamber A": LevelData(
        room_id=55,
        area_name="Celestial Archives",
...
VESPER_DEFENSE_OUTPOST: dict[str, LevelData] = {
    "VDO Gateway": LevelData(
        ...
        portal_file_name="unit3_Land_Ent",
    ),
    ...
    "Weapons Complex": LevelData(
        ...
        portal_file_name="unit3_RM1_Ent",
    ),
    "Compression Chamber": LevelData(
        room_id=69,
        area_name="Vesper Defense Outpost",
        entity_file="unit3_rm4_Ent",
        portal_file_name="unit3_RM4_Ent",
    ),
    "Stronghold Void A": LevelData(
        room_id=70,
        area_name="Vesper Defense Outpost",
        entity_file="Unit3_TP1_Ent",
        portal_file_name="Unit3_TP1_Ent",
    ),
    "Biodefense Chamber A": LevelData(
        room_id=71,
        area_name="Vesper Defense Outpost",
    ...
    "Stasis Bunker": LevelData(
        ...
        portal_file_name="unit3_RM3_Ent",
    ),
    "Stronghold Void B": LevelData(
        room_id=75,
        area_name="Vesper Defense Outpost",
        entity_file="Unit3_TP2_Ent",
        portal_file_name="Unit3_TP2_Ent",
    ),
    "Biodefense Chamber B": LevelData(
        room_id=76,
        area_name="Vesper Defense Outpost",
...
ARCTERRA: dict[str, LevelData] = {
    "Arcterra Gateway": LevelData(
        ...
        portal_file_name="unit4_Land_Ent",
    ),
    "Ice Hive": LevelData(
        room_id=78,
        area_name="Arcterra",
        entity_file="Unit4_RM1_Ent",
        portal_file_name="unit4_RM1_Ent",
    ),
    ...
    "Stronghold Void A": LevelData(
        ...
        portal_file_name="Unit4_TP1_Ent",
    ),
    "Biodefense Chamber A": LevelData(
        room_id=82,
        area_name="Arcterra",
    ...
    "Fault Line": LevelData(
        ...
        portal_file_name="unit4_RM5_Ent",
    ),
    "Stronghold Void B": LevelData(
        room_id=87,
        area_name="Arcterra",
        entity_file="Unit4_TP2_Ent",
        portal_file_name="Unit4_TP2_Ent",
    ),
    "Biodefense Chamber B": LevelData(
        room_id=88,
        area_name="Arcterra",
...
OUBLIETTE: dict[str, LevelData] = {
    "Oubliette Gateway": LevelData(
        ...
        portal_file_name="Gorea_Land_Ent",
    ),
    "Oubliette Storage": LevelData(
        room_id=90,
        area_name="Oubliette",
        entity_file="Gorea_Peek_Ent",
        portal_file_name="Gorea_Peek_Ent",
    ),
...
ALL_PORTAL_FILE_NAMES = [
    ...
    if (portal_file_name := level_data.portal_file_name) is not None
]
